(function() {
  ...
  (t = function(t) {
    ...
    return n = function(n) {
      return null == n && (n = {}),
        function(r, a) {
          // there is no 'width' or 'height' that I see, but c3 clearly let's you work with those elements
          // agg, attrs, base, base1, base2, base3, base4, base5, base6, base7, c, categories, colKey, colKeys, columns, dataColumns, defaults, formatter, fullAggName, groupByTitle, h, hAxisTitle, headers, i, j, k, l, len, len1, len2, len3, len4, m, numCharsInHAxis, numSeries, params, ref, ref1, ref2, ref3, renderArea, result, rotationAngle, row, rowHeader, rowKey, rowKeys, s, scatterData, series, title, titleText, vAxisTitle, val, vals, x, xs, y
          ...
          if (et = t("<p>", {
            ...
            }), et.text(nt), z = r.getAggregator([], []).format, W = {
              axis: {
            ...
            }, W = t.extend(!0, {}, W, a.c3), "scatter" === n.type) {
            it = {}, U = 0, j = [];
          ...
          return n.stacked && (n.horizontal ? W.data.groups = [function() {
            var t, e, n;
            for (n = [], e = 0, t = x.length; e < t; e++) lt = x[e], n.push(lt.join("-"));
            return n
          }()] : W.data.groups = [function() {
            var t, e, n;
            for (n = [], e = 0, t = Y.length; e < t; e++) lt = Y[e], n.push(lt.join("-"));
            return n
          }()]), J = t("<div>", {
            style: "display:none;"
          }).appendTo(t("body")), M = t("<div>").appendTo(J), W.bindto = M[0], e.generate(W), M.detach(), J.remove(), t("<div>").append(et, M)
        }
