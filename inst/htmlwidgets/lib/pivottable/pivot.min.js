      ...
      return "object" == typeof exports && "object" == typeof module ? t(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], t) : t(jQuery)
        ...
        return i = function(t, e, n) {
          ...
          try {
            ...
            M.unusedAttrsVertical === !0 || tt ? X.addClass("pvtVertList") : X.addClass("pvtHorizList"), w = function(n) {
              ...
              return o = function() {
                ...
                b = t("<span>").addClass("pvtTriangle").html(" &#x25BE;").bind("click",
                  function(e) {
                    var r;
                    return r = e.currentTarget).position().show()
          ...
          for (R = {
            ...
            t("<td>").addClass("pvtVals").appendTo($).append(u).append(P).append(v).append(t("<br>")),
            t("<td>").addClass("pvtAxisContainer pvtHorizList pvtCols").appendTo($),
            Q = t("<tr>").appendTo(Y),
            Q.append(t("<td>").addClass("pvtAxisContainer pvtRows").attr("valign", "top")),
            L = t("<td>").attr("valign", "top").addClass("pvtRendererArea").appendTo(Q),
            ...
            this.html(Y),
            z = M.cols, D = 0, T = z.length; D < T; D++) et = z[D],
          ...
          null != M.aggregatorName && this.find(".pvtAggregator").val(M.aggregatorName),
            null != M.rendererName && this.find(".pvtRenderer").val(M.rendererName), x = !0, j = function(n) {
              return function() {
