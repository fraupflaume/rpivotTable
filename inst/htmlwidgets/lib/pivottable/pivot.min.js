    ...
    return i = function(t, e, n) {
      ...
      for (d in i)
        if (a.call(i, d)) {
          ...
          0 === parseInt(d) && (w = document.createElement("th"), w.className = "pvtTotalLabel pvtRowTotalLabel", w.innerHTML = n.localeStrings.totals, w.setAttribute("rowspan", i.length + (0 === m.length ? 0 : 1)), S.appendChild(w)), A.appendChild(S)
        } if (0 !== m.length) {
      ...
      for (h in v)
        ...
        } S = document.createElement("tr"), w = document.createElement("th"), w.className = "pvtTotalLabel pvtColTotalLabel", w.innerHTML = n.localeStrings.totals, w.setAttribute("colspan", m.length + (0 === i.length ? 0 : 1)), S.appendChild(w);
      ...
      return x = e.getAggregator([], []), T = x.value(), y = document.createElement("td"), y.className = "pvtGrandTotal", y.textContent = x.format(T), y.setAttribute("data-value", T), null != c && (y.onclick = c(T, [], [])), S.appendChild(y), C.appendChild(S), f.appendChild(C), f.setAttribute("data-numrows", v.length), f.setAttribute("data-numcols", s.length), f
      ...
      var s, u, c, p, m, g, v, b, C, y, w, A, x, S, N, T, k, O, _, F, D, E, M, R, L, I, K, q, z, U, V, j, H, B, P, J, G, W, $, Q, Y, X, Z, tt, et;
      ...
      try {
        m = {}, F = [], I = 0, o.forEachRecord(n, M.derivedAttributes, function(t) {
          var e, n, r, o;
          if (M.filter(t)) {
            F.push(t);
          ...
          "class": "pvtUi"
        }).attr("cellpadding", 5), B = t("<td>"), H = t("<select>").addClass("pvtRenderer").appendTo(B).bind("change", function() {
          return V()
        }), K = M.renderers;
        for (et in K) a.call(K, et) && t("<option>").val(et).html(et).appendTo(H);
        if (X = t("<td>").addClass("pvtAxisContainer pvtUnused"), J = function() {
            var t;
            t = [];
        ...
        M.unusedAttrsVertical === !0 || tt ? X.addClass("pvtVertList") : X.addClass("pvtHorizList"), w = function(n) {
          ...
          return o = function() {
            ...
            var n, r, a;
            if( e.target != this ) { // because this is returning left and top within parent, but read as top and left of client
              return r = t(e.currentTarget).position(), n = r.target.offsetLeft + e.offsetX, a = r.target.offsetTop + e.offsetY, x.css({
                left: n,
                top: a
              }).show()
            }
        ...
        for (et in q) a.call(q, et) && u.append(t("<option>").val(et).html(et));
        for (R = {
            key_a_to_z: {
              rowSymbol: "&varr;",
              colSymbol: "&harr;",
          ...
          }), t("<td>").addClass("pvtVals").appendTo($).append(u).append(P).append(v).append(t("<br>")), t("<td>").addClass("pvtAxisContainer pvtHorizList pvtCols").appendTo($), Q = t("<tr>").appendTo(Y), Q.append(t("<td>").addClass("pvtAxisContainer pvtRows").attr("valign", "top")), L = t("<td>").attr("valign", "top").addClass("pvtRendererArea").appendTo(Q), M.unusedAttrsVertical === !0 || tt ? (Y.find("tr:nth-child(1)").prepend(B), Y.find("tr:nth-child(2)").prepend(X)) : Y.prepend(t("<tr>").append(B).append(X)), this.html(Y), z = M.cols, D = 0, T = z.length; D < T; D++) et = z[D], this.find(".pvtCols").append(this.find(".axis_" + t.inArray(et, W)));
        for (U = M.rows, E = 0, k = U.length; E < k; E++) et = U[E], this.find(".pvtRows").append(this.find(".axis_" + t.inArray(et, W)));
        null != M.aggregatorName && this.find(".pvtAggregator").val(M.aggregatorName), null != M.rendererName && this.find(".pvtRenderer").val(M.rendererName), x = !0, j = function(n) {
          return function() {
            ...
            if (x && (y = M.vals, A = 0, n.find(".pvtVals select.pvtAttrDropdown").each(function() {
              ...
              }).appendTo(C)), L.css("opacity", 1), null != M.onRefresh) return M.onRefresh(s)
          }
        }(this), V = function(t) {
          return function() {
            return L.css("opacity", .5), setTimeout(j, 10)
          }
